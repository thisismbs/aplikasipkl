<div class="row">
        <div class="col-md-auto">
          <div class="box box-primary box-solid col-md-auto">
            <div class="box-header with-border col-md-auto">
              <h3 class="box-title col-md-auto">Data Dokumen</h3>
            ...
            ?>
              <table class="table table-success table-striped" id="example1 container-fluid">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>No PO/Memo</th>
